...
namespace Ddxy.GameServer.Logic.Battle
{
    public class BattleMember
    {
        ...
        // 加速技能使用数据
#if false
        public List<uint> speedRoleList = null;
#endif
        // 孩子技能
        ...
        public void AddBuff(Buff buff)
        {
            ...
            else if (allEq)
            {
                ...
                Buffs[newIdx].CurRound = 0;
                Buffs[newIdx].Round = buff.Round;
            }
        }
        ...
        public bool JiRenTianXiang(uint round)
        {
            ...
            var effectData = skill.GetEffectData(new GetEffectDataRequest() { Member = this, Attrs = Attrs });
