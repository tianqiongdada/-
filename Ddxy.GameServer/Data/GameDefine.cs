...
namespace Ddxy.GameServer.Data
{
    public static class GameDefine
    {
        ...
        // 每日可击杀金翅大鹏的次数
        public const int EagleNumDaily = 1;
        ...
        public const int JadePerYuan = 1000;

        // FIXME: 每1元换多少积分 默认值 可后台修改
        public const int BindJadePerYuan = 2;
        ...
        // FIXME: 是否检查任务时，是否有队员已完成
        public static bool CheckTaskTeamMemberHasCompleted = false;

        // 转盘积分消耗
        public const uint LuckyDrawTurnCost = 10;

        // 限时充值排行榜活动结束后图标好久消失?
        public const uint LimitChargeIconDelay = 24 * 60 * 60;
        ...
        // 天策符--鉴定1件消耗仙玉
        public const uint TianCeFuJianDingCostJade = 1000;
        // 天策符--最多天策符数量
        public const uint TianCeFuMaxCount = 100;
        ...
        {
            new Tuple<uint, uint>(9903, 5),
            new Tuple<uint, uint>(50004, 10),
            new Tuple<uint, uint>(9904, 5),
            new Tuple<uint, uint>(60202, 1),
            new Tuple<uint, uint>(90004, 500000),
            new Tuple<uint, uint>(91001, 5)
        };
